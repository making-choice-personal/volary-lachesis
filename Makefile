...
opera:
	...
	go build \
	    -ldflags "-s -w -X github.com/making-choice-personal/volary-lachesis/cmd/opera/launcher.gitCommit=$${GIT_COMMIT} -X github.com/making-choice-personal/volary-lachesis/cmd/opera/launcher.gitDate=$${GIT_DATE}" \
	    -o build/opera \
	    ./cmd/opera
